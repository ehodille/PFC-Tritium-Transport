"""
Plot tritium inventory over time for a single simulation bin.
...
Data source:
  ...
  The file is found by globbing for the first integer in the filename.
  Keys used:
...
def main():
    ...
    # Collect all trap_N_T keys dynamically
    ...
    out_path = plots_dir / f"{json_path.stem}_inventory.png"
