...
|-----|----------|----------------------|----------------------|-------|
| 0 | mid-FW | 2.5 × 10²⁰ | 4.5 × 10⁵ | highest flux, peak loaded |
| 1 | upper FW | 6.8 × 10¹⁹ | 1.4 × 10⁵ | moderately loaded |
| 2 | lower FW | 5.0 × 10¹⁸ | 1.2 × 10⁵ | low-flux / shadowed |

Two files are provided:

- [`plasma_data/fp_pulse.dat`](plasma_data/fp_pulse.dat) — standard DT H-mode
- [`plasma_data/alternative_fp_pulse.dat`](plasma_data/alternative_fp_pulse.dat) — alternative magnetic configuration (same flux magnitudes, different spatial distribution: rows permuted across bins)
